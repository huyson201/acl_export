...
namespace Foostart\Acl\Authentication\Controllers;
...
use Foostart\Acl\Exports\UserProfileExport;
use Excel;
class UserController extends Controller
{
    ...
    {
        return  Excel::download(new UserProfileExport, 'list_users.xlsx');
    }
}
